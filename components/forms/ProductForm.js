...
const ProductForm = ({ data, mode = "create", onSubmit }) => {
  ...
  React.useEffect(() => {
    ...
    dispatch(getAllProducts(QueryString.stringify({ page_size: 5000 })));
    dispatch(getAlltags(QueryString.stringify({ page_size: 5000 })));
    dispatch(getAllBrands(QueryString.stringify({ page_size: 5000 })));
  }, [dispatch]);
  ...
  }, [categories, setValue, products, tags, brands]);
